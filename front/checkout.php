...
if(isset($_POST['action']) && $_POST['action']=='complete_booking'){
		...
		if(isset($_POST['recurrence_end_date'])){
			$recurrence_end_date_strtotime = strtotime($_POST['recurrence_end_date']);
			$recurrence_end_date = date('Y-m-d',$recurrence_end_date_strtotime);
		}
